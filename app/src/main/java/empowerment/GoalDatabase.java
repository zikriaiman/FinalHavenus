...
public class GoalDatabase extends SQLiteOpenHelper {
    ...
    public void insertPost(Goal post) {
    ...
    public List<Goal> getAllNotes() {
        List<Goal> postList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            Goal post = new Goal(id, title, content);
            postList.add(post);
        }
    ...
    public void updatePost(Goal post) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_TITLE, post.getTitle());
        values.put(COLUMN_CONTENT, post.getContent());
    ...
    public Goal getPostByID(int postID) {
        SQLiteDatabase db = getReadableDatabase();
        ...
        return new Goal(id, title, content);
    }
